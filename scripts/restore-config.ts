...
const TOOLS = [
  ...
  { id: '26d87c6c-5ec5-4a56-9540-398cb1bdc52a', version: 1 },  // get_conversation_context (fixed)
]
...
async function restoreConfig() {
  ...
  const body = {
    version_description: 'OPUS 4.5: British voice + Custom LLM (claude-opus-4-5-20251101)',
    evi_version: '3',
    // NOTE: Prompt must be injected by CLM, not Hume config (not supported with custom LLM)
    voice: {
      provider: 'HUME_AI',
